...
*/
	...
	KEYMAP(
		DE_CIRC,  DE_1,       DE_2,     DE_3,     DE_4,     DE_5,     DE_6,     DE_7, 	DE_8, 		DE_9,		DE_0, 		DE_SS,    DE_ACUT, 	KC_BSPC, 	KC_BSPC,
    ...
    KC_TRNS,  KC_TRNS,   KC_VOLU,  KC_TRNS,   KC_TRNS,   KC_TRNS,    KC_TRNS,     KC_PGUP,   KC_UP,       KC_PGDN,      KC_PSCR,   KC_SLCK,    KC_PAUS,   KC_ENT,
    KC_CAPS,  KC_MPRV,    KC_VOLD,  KC_MNXT,  KC_TRNS,    KC_TRNS,    KC_HOME,     KC_LEFT,   KC_DOWN,    KC_RIGHT,    KC_END,    KC_TRNS,    KC_TRNS,
    KC_LSFT,  DE_LESS,   RGB_TOG,  RGB_MOD,   RGB_VAD,   RGB_VAI,    RGB_SAD,     RGB_SAI,   KC_TRNS,     RGB_HUD,    RGB_HUI,   DE_MINS,    KC_RSFT,   KC_TRNS,
